...
// Core Registers
//
#define DWHCI_CORE_OTG_CTRL (USB_CORE_BASE + 0x000)
#define DWHCI_CORE_OTG_CTRL_HST_SET_HNP_EN (1 << 10)
#define DWHCI_CORE_OTG_INT (USB_CORE_BASE + 0x004)
#define DWHCI_CORE_AHB_CFG (USB_CORE_BASE + 0x008)
...
#define DWHCI_CORE_USB_CFG (USB_CORE_BASE + 0x00C)
...
#define DWHCI_CORE_RESET (USB_CORE_BASE + 0x010)
...
#define DWHCI_CORE_RX_STAT_RD (USB_CORE_BASE + 0x01C) // RO, slave mode only
#define DWHCI_CORE_RX_STAT_POP (USB_CORE_BASE + 0x020)// RO, slave mode only
...
#define DWHCI_CORE_RX_FIFO_SIZ (USB_CORE_BASE + 0x024)
#define DWHCI_CORE_NPER_TX_FIFO_SIZ (USB_CORE_BASE + 0x028)
#define DWHCI_CORE_NPER_TX_STAT (USB_CORE_BASE + 0x02C)// RO
#define DWHCI_CORE_NPER_TX_STAT_QUEUE_SPACE_AVL(reg) (((reg) >> 16) & 0xFF)
#define DWHCI_CORE_I2C_CTRL (USB_CORE_BASE + 0x030)
#define DWHCI_CORE_PHY_VENDOR_CTRL (USB_CORE_BASE + 0x034)
#define DWHCI_CORE_GPIO (USB_CORE_BASE + 0x038)
#define DWHCI_CORE_USER_ID (USB_CORE_BASE + 0x03C)
#define DWHCI_CORE_VENDOR_ID (USB_CORE_BASE + 0x040)
#define DWHCI_CORE_HW_CFG1 (USB_CORE_BASE + 0x044)// RO
#define DWHCI_CORE_HW_CFG2 (USB_CORE_BASE + 0x048)// RO
...
#define DWHCI_CORE_HW_CFG3 (USB_CORE_BASE + 0x04C)// RO
#define DWHCI_CORE_HW_CFG3_DFIFO_DEPTH(reg) (((reg) >> 16) & 0xFFFF)
#define DWHCI_CORE_HW_CFG4 (USB_CORE_BASE + 0x050)// RO
#define DWHCI_CORE_HW_CFG4_DED_FIFO_EN (1 << 25)
#define DWHCI_CORE_HW_CFG4_NUM_IN_EPS(reg) (((reg) >> 26) & 0xF)
#define DWHCI_CORE_LPM_CFG (USB_CORE_BASE + 0x054)
#define DWHCI_CORE_POWER_DOWN (USB_CORE_BASE + 0x058)
#define DWHCI_CORE_DFIFO_CFG (USB_CORE_BASE + 0x05C)
#define DWHCI_CORE_DFIFO_CFG_EPINFO_BASE__SHIFT 16
#define DWHCI_CORE_DFIFO_CFG_EPINFO_BASE__MASK (0xFFFF << 16)
#define DWHCI_CORE_ADP_CTRL (USB_CORE_BASE + 0x060)
// gap
#define DWHCI_VENDOR_MDIO_CTRL (USB_CORE_BASE + 0x080)// BCM2835 only
#define DWHCI_VENDOR_MDIO_DATA (USB_CORE_BASE + 0x084)// BCM2835 only
#define DWHCI_VENDOR_VBUS_DRV (USB_CORE_BASE + 0x088) // BCM2835 only
// gap
#define DWHCI_CORE_HOST_PER_TX_FIFO_SIZ (USB_CORE_BASE + 0x100)
// fifo := 0..14 :
#define DWHCI_CORE_DEV_PER_TX_FIFO(fifo) (USB_CORE_BASE + 0x104 + (fifo) *4)// dedicated FIFOs on
#define DWHCI_CORE_DEV_TX_FIFO(fifo) (USB_CORE_BASE + 0x104 + (fifo) *4)    // dedicated FIFOs off
...
#define DWHCI_HOST_FRM_INTERVAL (USB_HOST_BASE + 0x004)
#define DWHCI_HOST_FRM_NUM (USB_HOST_BASE + 0x008)
...
// gap
#define DWHCI_HOST_PER_TX_FIFO_STAT (USB_HOST_BASE + 0x010)
#define DWHCI_HOST_ALLCHAN_INT (USB_HOST_BASE + 0x014)
#define DWHCI_HOST_ALLCHAN_INT_MASK (USB_HOST_BASE + 0x018)
#define DWHCI_HOST_FRMLST_BASE (USB_HOST_BASE + 0x01C)
// gap
...
#define DWHCI_HOST_PORT_DEFAULT_MASK (DWHCI_HOST_PORT_CONNECT_CHANGED | DWHCI_HOST_PORT_ENABLE | DWHCI_HOST_PORT_ENABLE_CHANGED | DWHCI_HOST_PORT_OVERCURRENT_CHANGED)
// gap
// chan := 0..15 :
...
#define DWHCI_HOST_CHAN_INT(chan) (USB_HOST_BASE + 0x108 + (chan) *0x20)
...
#define DWHCI_HOST_CHAN_INT_ERROR_MASK (DWHCI_HOST_CHAN_INT_AHB_ERROR | DWHCI_HOST_CHAN_INT_STALL | DWHCI_HOST_CHAN_INT_XACT_ERROR | DWHCI_HOST_CHAN_INT_BABBLE_ERROR | DWHCI_HOST_CHAN_INT_FRAME_OVERRUN | DWHCI_HOST_CHAN_INT_DATA_TOGGLE_ERROR)
#define DWHCI_HOST_CHAN_INT_MASK(chan) (USB_HOST_BASE + 0x10C + (chan) *0x20)
...
//
#define DWHCI_DATA_FIFO(chan) (USB_HOST_BASE + 0x1000 + (chan) *DWHCI_DATA_FIFO_SIZE)
