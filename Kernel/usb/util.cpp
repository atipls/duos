...
void *uspi_memset (void *pBuffer, int nValue, usize nLength)
{
	char *p = (char *) pBuffer;
...
void *uspi_memcpy (void *pDest, const void *pSrc, usize nLength)
{
	char *pd = (char *) pDest;
	char *ps = (char *) pSrc;
...
int uspi_memcmp (const void *pBuffer1, const void *pBuffer2, usize nLength)
{
...
usize uspi_strlen (const char *pString)
{
	usize nResult = 0;
...
char *uspi_strncpy (char *pDest, const char *pSrc, usize nMaxLen)
{
	char *pResult = pDest;
